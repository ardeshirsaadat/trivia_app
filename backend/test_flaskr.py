...
class TriviaTestCase(unittest.TestCase):
    ...
    def test_questions_post(self):
        res = self.client().post('/questions',
                                 json={'question': 'why', 'answer': 'yes', 'difficulty': 3, 'category': 1})
        data = json.loads(res.data)
    ...
    def test_500_questions_post(self):
        res = self.client().post('/questions',
                                 json={'question': 'why', 'answer': 'yes', 'difficulty': 3, 'category': "fd"})
        data = json.loads(res.data)
    ...
    def test_404_quizzes_post(self):
        res = self.client().post(
            '/quizzes', json={'previous_questions': [1, 5], 'quiz_category': [{'id': 20}]})
        data = json.loads(res.data)
